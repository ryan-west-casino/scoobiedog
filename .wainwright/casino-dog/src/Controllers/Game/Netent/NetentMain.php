...
class NetentMain extends GameKernel
{
    use GameKernelTrait;
    ...
    */
    ...
    public function prelauncher_view(Request $request) {
        return view('wainwright::launcher-netent')->with('game_request', $request);
    }
