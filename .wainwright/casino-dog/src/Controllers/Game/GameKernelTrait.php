...
use Wainwright\CasinoDog\Models\GameTemplate;
...
trait GameKernelTrait
{
    ...
    public function save_game($gid, $game_data, $debit, $credit, $round_id, $round_state, $game_type)
    {
        $gametemplate = new GameTemplate;
        $gametemplate->save_game_template($gid, $game_data, $debit, $credit, $round_id, $round_state, $game_type);
    }
