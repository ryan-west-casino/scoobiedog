...
Route::middleware('web', 'throttle:5000,1')->group(function () {
...
Route::any('/casino/relax_static_assets/relax_logo.svg', function (Request $request) {
    return Http::get('https://cf-iomeu-cdn.relaxg.com/casino/relax_static_assets/relax_logo.svg');
});
