...
class Gameslist extends Resource
{
    ...
    public function actions(NovaRequest $request)
    {
        return [
            ...
            ->confirmButtonText('Start Job')
            ->cancelButtonText("Cancel"),
            (new Actions\TemplateGatheringFlag)->showInline()->showOnIndex()->showOnDetail()
            ->confirmText('Set game to queue to be used at random in data gathering puppeteer.')
            ->confirmButtonText('Flag for data gathering')
            ->cancelButtonText("Cancel"),
